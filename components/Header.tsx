...
interface HeaderProps {
  ...
  onTrainerClick?: () => void;
  onMyTrainerClick?: () => void;
  isTrainer?: boolean;
  hasTrainer?: boolean;
  userName?: string;
}

const Header: React.FC<HeaderProps> = ({ onCartClick, onSettingsClick, onTrainerClick, onMyTrainerClick, isTrainer, hasTrainer, userName }) => {
      ...
      <div className="flex items-center gap-2">
        ...
        {hasTrainer && !isTrainer && onMyTrainerClick && (
          <button
            ...
            className="p-2 text-purple-400 hover:text-purple-300 transition-colors bg-purple-500/10 rounded-full"
            title="My Trainer"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
